...
def create_file(pair, granularity, api):
    ...
    end_date = utils.get_utc_dt_from_string("2022-08-23 18:44:59")
    date_from = utils.get_utc_dt_from_string("2022-06-23 00:00:00")
...
def run_collection():
    pair_list = "GBP,EUR,USD,AUD,CAD,JPY,NZD,CHF"
    api = OandaAPI()
